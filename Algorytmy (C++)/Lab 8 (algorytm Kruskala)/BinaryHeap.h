...
{
	//if (i >= end && (2*i+1 > end && 2*i+2 > end))
	//{
	//	if (end == 1) std::cout << "RETURN";
	//	return;
	//}	
	//else if (2*i+1 <= end && heap->operator[](i) < heap->operator[](2 * i + 1) && heap->operator[](2 * i + 1) > heap->operator[](2 * i + 2))
	//{
	//	if (end == 1) std::cout << "KONONM";
	//	heap->swap(i, 2 * i + 1);
	//	heapify_down(2 * i + 1, end);
	//} 
	//else if (2*i+2 <= end && heap->operator[](i) < heap->operator[](2 * i + 2) && heap->operator[](2 * i + 2) > heap->operator[](2 * i + 1))
	//{
	//	if (end == 1) std::cout << "MAJOR";
	//	heap->swap(i, 2 * i + 2);
	//	heapify_down(2 * i + 2, end);
	//}
	//if (end == 1) std::cout << "sadadasdadadad";
	////return;
